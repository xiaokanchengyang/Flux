...
use crate::components::{DropZone, FluxButton, FluxProgress};
use crate::layout::{draw_file_card, Card};
    ...
    ui.horizontal(|ui| {
        ...
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            if view_ctx.is_busy {
                ...
                if ui
                    .add(FluxButton::new("Clear All").ghost().icon(regular::TRASH))
                    .clicked()
                {
    ...
    if view_ctx.input_files.is_empty() {
        ...
        egui::ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ...
                let spacing = 10.0;
                let cards_per_row =
                    ((ui.available_width() + spacing) / (card_width + spacing)).floor() as usize;
